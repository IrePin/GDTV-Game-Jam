...
public class Projectile : MonoBehaviour
{
    public ProjectileType
        projectileType =
            ProjectileType
                .Standard; // The type of projectile - Standard is a straight forward moving projectile, Seeker type seeks GameObjects with a specified tag

    public DamageType
        damageType =
            DamageType.Direct; // The damage type - Direct applys damage directly from the projectile, Explosion lets an instantiated explosion handle damage
    ...
    public float
        targetListUpdateRate = 1.0f; // The rate at which the projectile will update its list of all enemies to target

    public GameObject
        clusterBomb; // The array of bombs to be instantiated on explode if this projectile is of clusterbomb type
    ...
    private float
        targetListUpdateTimer =
            0.0f; // The timer to keep track of how long it's been since the enemy list was last updated
